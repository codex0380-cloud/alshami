...
(function () {
  ...
  const FAQS = [
    ...
    { q: 'إيه أرقام التواصل والطلبات؟', a: 'تقدر تتواصل معانا على: 01037775765' },
    { q: 'بتوصلوا فين؟', a: 'بنوصل لكل مناطق إيتاي البارود (حديقة الطفل، شارع تاون تيم وغيرها).' },
    { q: 'أقدر أطلب إزاي؟', a: 'تقدر تطلب من الموقع مباشرة، أو تكلمنا على الواتساب: 01037775765' },
  ...
  const isStoreOpenNow = () => {
    ...
    if (STORE_SETTINGS.store_status === 'always_open') return true;
